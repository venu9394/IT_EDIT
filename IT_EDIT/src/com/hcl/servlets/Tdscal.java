...
public Tdscal() {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
  {
    ...
    if (Donation!=null && !Donation.equalsIgnoreCase("Select Organization") ) {
      ...
      */
      ...
      if(i>0){
    	  try{
    		  ...
    		  UpdateITS.append(" UPDATE test.tbl_emp_it_tds SET STATUS=1005 ");
    		  UpdateITS.append(" WHERE REFNO IN (SELECT MAX(b.REFNO) ");
    		  UpdateITS.append(" FROM (SELECT * FROM test.tbl_emp_it_tds) AS B ");
    		  UpdateITS.append(" WHERE B.EMPLOYEEID="+id+" AND B.FY='"+financialyear+"' AND B.REFNO NOT IN ("+Key+") AND STATUS=1001) AND STATUS=1001");  
    		  int l=0;    	      
    		  PreparedStatement ps = con.prepareStatement(UpdateITS.toString());
    		  System.out.println(ps.toString());
    		  l=ps.executeUpdate();
